...
namespace PiPi
{
	...
	public:
		PiPiEditor(PdfMemDocument *document, PiPiFontManager *fontManager, PiPiAppearanceManager *appearanceManager, PiPiFieldManager *fieldManager, PiPiFieldStyleManager *fieldStyleManager, PiPiFlattenManager *flattenManager);
